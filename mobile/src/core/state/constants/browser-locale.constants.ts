import type { BrowserLocaleMapping } from "../declarations/browser-locale.types";

/**
 * In React Native, we use the device locale from expo-localization
 * rather than navigator.languages. The patterns remain the same.
 */
export const BROWSER_LOCALE_MAPPINGS: readonly BrowserLocaleMapping[] =
  Object.freeze([
    ...
    {
      countryProfileId: "in",
      pattern: /^(?:en|hi|bn|gu|kn|ml|mr|pa|ta|te)-in$/iu,
    },
    ...
    { countryProfileId: "pe", pattern: /^es-pe$/iu },
    {
      ...
      pattern: /^es-(?:419|bo|cr|cu|do|ec|gt|hn|ni|pa|pr|py|sv|uy|ve)$/iu,
    },
