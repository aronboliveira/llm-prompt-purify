...
export const CROSS_SCOPE_POSITIVE: readonly LocaleMaskFixture[] = Object.freeze([
  {
    ...
    sourceText:
      "CPF 529.982.247-25 e CUIT 20-12345678-6 no mesmo documento.",
  },
  {
  ...
  },
  {
    ...
    sourceText:
      "CPF: 529.982.247-25 NIF: 123456789 lusophone treaty.",
  },
  {
...
export const CROSS_SCOPE_GLOBAL_ONLY: readonly BoundaryMaskFixture[] =
  Object.freeze([
    ...
    },
    {
      ...
      description:
        "global-only mode does NOT mask RU INN/SNILS but masks JWT",
      detectionMode: "global-only",
...
export const CROSS_SCOPE_STRESS: readonly BoundaryMaskFixture[] = Object.freeze([
  ...
  },
  {
    ...
    description:
      "all 12 countries active: kitchen-sink stress test",
    expectedRuleIds: [
      "cpf",
      "us-ssn",
      "cn-resident-id-labeled",
