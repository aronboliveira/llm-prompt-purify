...
export const FEEDBACK_CATEGORY_OPTIONS: readonly FeedbackCategoryOption[] = Object.freeze([
  {
...
export const FEEDBACK_CATEGORY_IDS: readonly FeedbackCategoryId[] = Object.freeze(
  FEEDBACK_CATEGORY_OPTIONS.map(option => option.id)
);

export const FEEDBACK_RATING_OPTIONS: readonly number[] = Object.freeze([1, 2, 3, 4, 5]);
