...
def _run_single_type(df: pd.DataFrame, region: str) -> pd.DataFrame:
    ...
    for _, r in df.iterrows():
        ...
        found = [d for d in results if d.rule_id == r["expected_rule_id"]]
        matched = bool(found)
...
def main() -> None:
    frames = [
        ...
        _run_single_type(FINANCIAL_DF, "FIN"),
        ...
        _run_single_type(LABELED_GENERIC_DF, "LABELED"),
        _run_multi(MULTI_DF),
    ]
