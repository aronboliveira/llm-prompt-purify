...
export const BR_BOUNDARY: readonly BoundaryMaskFixture[] = Object.freeze([
  {
    ...
    description: "CPF stays visible when US is selected, email still masked",
    excludedRuleIds: ["cpf"],
  ...
  },
  {
    ...
    description: "CPF stays visible in global-only mode, email still masked",
    excludedRuleIds: ["cpf"],
    expectedRuleIds: ["email-address"],
    hiddenValues: ["maria@example.com"],
    sourceText: "CPF: 529.982.247-25\nEmail: maria@example.com",
  ...
  },
  {
    ...
    description: "CNPJ stays visible when Spain is selected",
    excludedRuleIds: ["cnpj"],
    sourceText: "CNPJ: 11.222.333/0001-81",
    visibleValues: ["11.222.333/0001-81"],
  },
  {
